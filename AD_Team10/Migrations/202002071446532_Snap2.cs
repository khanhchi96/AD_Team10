namespace AD_Team10.Migrations
{
    ...
    public partial class Snap2 : DbMigration
    {
        public override void Up()
        {
            ...
            //StoreUsers
            Sql("INSERT INTO StoreUsers(Username,Password,Role,StoreEmployeeID) Values('yusofbin@u.logic.edu','1234',2,1)");
            Sql("INSERT INTO StoreUsers(Username,Password,Role,StoreEmployeeID) Values('fandiahmad@u.logic.edu','2345',3,2)");
            Sql("INSERT INTO StoreUsers(Username,Password,Role,StoreEmployeeID) Values('angpeng@u.logic.edu','3456',1,3)");
            Sql("INSERT INTO StoreUsers(Username,Password,Role,StoreEmployeeID) Values('jeanetteaw@u.logic.edu','4567',1,4)");
            Sql("INSERT INTO StoreUsers(Username,Password,Role,StoreEmployeeID) Values('vivibala@u.logic.edu','5678',1,5)");
            ...
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Clips Double 2','Dozen',50,30,70,1)");
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Clips Double 3/4','Dozen',50,30,63,1)");
            ...
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Clips Paper Medium','Box',50,30,54,1)");//5
            ...
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Envelope Brown(5x7) w/ Window','Each',600,400,700,2)");//10
            ...
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Envelope White(3x6) w/ Window','Each',600,400,620,2)");
            ...
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Folder Plastic Blue','Each',200,150,220,6)");//30
            ...
            Sql("INSERT INTO Items(Description,UnitOfMeasure,ReorderLevel,ReorderQuantity,UnitsInStock,CategoryID) Values('Highlighter Green','Box',100,80,135,9)");
