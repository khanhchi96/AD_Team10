namespace AD_Team10.Migrations
{
    ...
    public partial class Snap1 : DbMigration
    {
        public override void Up()
        {
            ...
            Sql("INSERT INTO Categories(CategoryName) Values('Eraser')");//3
            Sql("INSERT INTO Categories(CategoryName) Values('Exercise')");//4
            Sql("INSERT INTO Categories(CategoryName) Values('File')");//5
            Sql("INSERT INTO Categories(CategoryName) Values('Folder')");//6
            Sql("INSERT INTO Categories(CategoryName) Values('Pad')");//7
            Sql("INSERT INTO Categories(CategoryName) Values('Paper')");//8
            Sql("INSERT INTO Categories(CategoryName) Values('Pen')");//9
            Sql("INSERT INTO Categories(CategoryName) Values('Puncher')");//10
            Sql("INSERT INTO Categories(CategoryName) Values('Ruler')");//11
            Sql("INSERT INTO Categories(CategoryName) Values('Scissors')");//12
            Sql("INSERT INTO Categories(CategoryName) Values('Sharpener')");//13
            Sql("INSERT INTO Categories(CategoryName) Values('Shorthand')");//14
            Sql("INSERT INTO Categories(CategoryName) Values('Stapler')");//15
            Sql("INSERT INTO Categories(CategoryName) Values('Tacks')");//16
            Sql("INSERT INTO Categories(CategoryName) Values('Tape')");//17
            Sql("INSERT INTO Categories(CategoryName) Values('Tparency')");//18
            Sql("INSERT INTO Categories(CategoryName) Values('Tray')");//19
            ...
            //StoreEmployees
            Sql("INSERT INTO StoreEmployees(FirstName,LastName,MiddleName,Phone,Address,Gender,Email,Designation) Values('Yusof','bin','Ishak','8834 7761','Blk 321C Kranji Road,#02-302,Singapore 650 321','F','yusofbin@u.logic.edu','Manager')");
            Sql("INSERT INTO StoreEmployees(FirstName,LastName,MiddleName,Phone,Address,Gender,Email,Designation) Values('Fandi','Ahmad','','8904 2673','Blk 234D Woodlands Drive, #12-312,Singapore 604 234,','M','fandiahmad@u.logic.edu','Supervisor')");
