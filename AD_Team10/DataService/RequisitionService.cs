...
namespace AD_Team10.DataService
{
    public class RequisitionService
    {
        ...
        public bool IsCompleted(Requisition requisition)
        {
            ...
            {
                if(requisition.RequisitionDetails[i].Quantity != requisition.RequisitionDetails[i].QuantityReceived)
                {
                    isCompleted = false;
                    break;
                }
        ...
        public RetrievalList GenerateRetrievalList()
        {
            ...
            RetrievalList retrievalList = dBContext.RetrievalLists.Include(x => x.Requisitions)
